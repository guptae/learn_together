...
<body>
  <ol>
    ...
    <li><a style="color: yellow" href="complexdeadlockV2.jsp">Complex Deadlock Information</a></li>
  </ol>
  <div>
    ...
    <%
	  ...
	  if(null != oldSession)
	  {
	    ...
	    Map<String, String> complexDeadlockThreadMap = (Map<String, String>)((Map<String, Object>) oldSession.getAttribute("E:\\eclipse_playarea\\thread-dump-analyzer\\src\\com\\guptae\\resources\\" + filename)).get("complexDeadlockThreadMap");
	    ...
	    Map<String, ThreadInfo> complexDeadlockThreadInfoMap = (Map<String, ThreadInfo>)((Map<String, Object>) oldSession.getAttribute("E:\\eclipse_playarea\\thread-dump-analyzer\\src\\com\\guptae\\resources\\" + filename)).get("complexDeadLockThreadInfoMap");
